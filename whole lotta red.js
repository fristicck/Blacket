...
// form page color
rall('#contextMenu', 'backgroundColor', '#3D0303')
// right click delete button background
rall('#contextMenu', 'color', '#EE4B2B');
// right click delete button text
rall('#contextMenu', 'border', '3px solid #EE4B2B');
// right click delete button border'
rall('#bb_contextmenu', 'border', '3px solid #EE4B2B');
// right click bb border color
rall('.mo', 'color', '#EE4B2B');
// right click bb text color